...
namespace DeTai4_DRP_N18DCCN020 {
    public partial class _Default : System.Web.UI.Page {
        ...
        protected void Page_Load(object sender, EventArgs e) {
            ...
            GridView1.ID = "ASPxGridView1";
            
            String query = Session["query"].ToString();
            SqlDataSource SqlDataSource1 = new SqlDataSource();
            SqlDataSource1.ID = "SqlDataSource1";
            this.Page.Controls.Add(SqlDataSource1);
            SqlDataSource1.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["dbstring"].ConnectionString;
            ...
            */
            ...
            String connect = "Data Source=SNORLAX;Initial Catalog=QLVT18;Integrated Security=True";
